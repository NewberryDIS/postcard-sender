...
def process_gallery_data(gallery, gallery_api_data):
    gallery.update(
        {
            "image": gallery_api_data["APIResponse"]["Representative"][
...
def process_postcard_data(postcard, postcard_api_data):
    if postcard_api_data["APIResponse"]["CoreField.IIIFResourceType"] == "Canvas":
        ...
        postcard.update(
            {
                "image": postcard_api_data["APIResponse"]["Representative"][
                    "MediaEncryptedIdentifier"
                ],
                "imageTitle": postcard_api_data["APIResponse"]["Representative"][
                    "Title"
                ],
                "width": postcard_api_data["APIResponse"]["Representative"]["MaxWidth"],
                "height": postcard_api_data["APIResponse"]["Representative"][
                    "MaxHeight"
                ],
            }
        )
